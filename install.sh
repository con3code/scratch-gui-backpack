...
cp ${REPO_ID}/scratch-gui/src/containers/backpack.jsx src/containers/
cp ${REPO_ID}/scratch-gui/src/lib/backpack-api.js src/lib/
cp ${REPO_ID}/scratch-gui/src/components/modal/modal.css src/components/modal/
cp ${REPO_ID}/scratch-gui/src/playground/render-gui.jsx src/playground/
